                ...
                <div class="update-form">
                    <form action="" method="POST">
                        ...
                        <input type="text" class="update-form<?php echo (!empty($data['publication_title_error'])) ? '-error' : '';
                                                                   echo (!empty($data['publication_title_len_error'])) ? '-error' : ''; ?>" placeholder="Publication Title" name="publication_title" value="<?php echo (!empty($data['publication_title'])) ? $data['publication_title'] : ''; ?>">
                        ...
                        <label>
                            <input type="checkbox" name="private_check" <?php if(($data['publication_status'])=='private'){echo 'checked';};?>>Private Post?
                        </label>
